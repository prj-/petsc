  ...
  for (d = 0; d < nvec; d++) {
    ...
    if (rank == First) {
      ...
      if (rank == Last) {
        ...
        for (PetscInt k = d + 1; k < nvec; k++) *RLOC(k, d) = 0.0;
      }
    }
  }
