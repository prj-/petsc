...
int main(int argc, char **argv)
{
  ...
  PetscCall(DMDestroy(&seqdmU));
  PetscCall(ISDestroy(&seqisU));
  PetscCall(DMDestroy(&seqdmA));
  PetscCall(ISDestroy(&seqisA));
  PetscCall(DMDestroy(&seqdmS));
  PetscCall(ISDestroy(&seqisS));
  PetscCall(DMDestroy(&seqdmUA));
  PetscCall(ISDestroy(&seqisUA));
  ...
  PetscCall(DMDestroy(&dmUA));
  PetscCall(ISDestroy(&isUA));
